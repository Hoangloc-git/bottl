...
parser = argparse.ArgumentParser(description='Tool spam SMS')
parser.add_argument('phone', type=str, help='Số điện thoại cần spam')
parser.add_argument('count', type=int, help='Số lần spam (0 = vô hạn)')
parser.add_argument('delay', type=int, help='Delay giữa các lần spam')
...
print('─'*50)
print(f'[INFO] Số điện thoại: {sdt}')
print(f'[INFO] Số lần spam: {"VÔ HẠN" if spam == 0 else spam}')
print(f'[INFO] Delay: {delay}')
print(f'[INFO] Số luồng: {max_workers}')
print('─'*50)

threading = ThreadPoolExecutor(max_workers=max_workers)
